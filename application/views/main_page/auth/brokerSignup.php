		...
		<div class="col-lg-12">
			...
			<div class="form-content-box2" ng-app="registration-app">
				...
				<div class="details" ng-controller="register-form">
					...
					<!-- Form start-->
					<form action="<?php echo base_url('main_controller/saveBrokerData');?>" method="POST" name="regi_form">
						<div class="row">
							<div class="col-sm-6">
						...
						<div class="row">
							...
							<div class="col-sm-6">
								<div class="form-group">
									<input type="text" name="billing_info" class="input-text" placeholder="Billing Info" ng-model="billing_info" oninvalid="this.setCustomValidity('Please Enter Billing Info Number.')" oninput="this.setCustomValidity('')" required>
									<span ng-show="regi_form.billing_info.$touched && regi_form.billing_info.$invalid" class="val_red">
										<span ng-show="regi_form.billing_info.$error.required" class="val_red">
											Please Enter Billing Info.
										</span>
									</span>
								</div>
							</div>
