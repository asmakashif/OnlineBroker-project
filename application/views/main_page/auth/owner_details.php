		...
		<div class="col-lg-12">
			...
			<div class="form-content-box2" ng-app="registration-app">
				...
				<div class="details" ng-controller="register-form">
					...
					<!-- Form start-->
					<form action="<?php echo base_url('userController/saveOwnerData');?>" method="POST" name="regi_form">
						<div id="ifAgency">
							<div class="row">
								<div class="col-sm-6">
									<div class="radio">
						...
						<div id="ifIndividual" style="display:none">
							<div class="row">
    							...
    							<div class="col-sm-6">
        							<div class="form-group">
										<input type="text" name="broker_id" class="input-text" readonly="readonly" value="<?php $cc = $this->db->select('*');$this->db->from('tbl_broker');$this->db->where('own_agency','Yes');$cc= $this->db->count_all_results()+1;
    					...
    					<div id="ifNo" style="display:none">
							<div class="row">
								<div class="col-sm-6">
									<div class="form-group">
										<input name="owner_email" class="form-control" type="email" placeholder="Enter Email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" value="<?php echo set_value('email'); ?>"/>
