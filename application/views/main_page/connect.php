        ...
        <div class="row">
            <div class="col-lg-7 col-md-7 col-sm-6 col-xs-12">
                ...
                <div class="contact-form">
                    <form id="contact_form" action="contact-submit.php" method="POST" enctype="multipart/form-data">
                        <div class="row">
                ...
                <div class="col-lg-12 col-md-6 col-sm-12 col-xs-12">
                    <div class="form-group send-btn mb-0">
                        <button type="submit" class="button-md button-theme">Connect Now</button>
                    </div>
                </div>
            </div>                    </form>     
                </div>
        ...
        <div class="contact-details">
            ...
            <div class="media">
                ...
                <div class="media-body">
                    ...
                    <p>20/F Dcghn Ffgj FghjtgVdtgfj Tbfgjfgf</p>
                </div>
            </div>
            <div class="media">
                <div class="media-left">
                ...
                <div class="media-body">
                    <h4>Phone Number</h4>
                    <p>
                        <a href="tel:1234567890">office: 1234567890</a>
                    </p>
                    <p>
                        <a href="tel:987654321">Mobile: 987654321</a>
                    </p>
                </div>
            </div>
            <div class="media mb-0">
                ...
                <div class="media-body">
                    <h4>Email Address</h4>
                    <p>
                        <a href="mailto:1234@gmail.com">abcd@gmail.com</a>
                    </p>
                    <p>
                        <a href="mailto:1234@gmail.com" target="_blank">1234@gmail.com</a>
                    </p>
                </div>
            </div>
        </div>
